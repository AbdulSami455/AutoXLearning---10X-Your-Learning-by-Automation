...
def dashboardf():
     ...
     headlineframe.place(x=80, y=340, relwidth=0.85, relheight=0.20)
     ...
     heading6 = ctk.CTkLabel(dash, text=topheadlines[4], font=("Helvetica", 10, "bold"))
     heading6.place(x=90, y=430)
